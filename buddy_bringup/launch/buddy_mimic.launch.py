...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            name='rviz2',
            output='screen',
            arguments=['-d', os.path.join(get_package_share_directory('buddy_bringup'), 'config', 'buddy_mimic.rviz')]),
        Node(
            package="usb_cam",
        ...
        Node(
            package='buddy_arm_mimic',
            executable='buddy_controller',
            name='buddy_controller',
            output='screen'
        ),
    ])