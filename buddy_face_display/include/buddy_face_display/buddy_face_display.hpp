#ifndef BUDDY_FACE_DISPLAY_HPP_
#define BUDDY_FACE_DISPLAY_HPP_
...
class BuddyFaceDisplay : public rviz_common::Display
{
Q_OBJECT
public:
  BuddyFaceDisplay();
  ~BuddyFaceDisplay() override;
