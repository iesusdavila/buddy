...
private:
    ...
    void arm_tracker_callback(const coco_interfaces::msg::BodyPosition::SharedPtr msg) {
    ...
    std::pair<std::map<std::string, float>, Position2D> process_arm(const coco_interfaces::msg::BodyPosition::SharedPtr msg, bool is_right_arm) {
